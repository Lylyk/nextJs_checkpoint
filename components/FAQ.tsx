...
const FAQ = () => {
  return (
    <section className='bg-gradient-to-r from-pink-200 to-yellow-200 pb-20 pt-36' id='FAQ'>
      <div className='container sm:px-2'>
        <div>
          <h1 className='text-[40px] font-bold uppercase leading-[3rem] text-black'>
      ...
      <div className='center mt-36 flex justify-center py-4'>
        <div className='flex w-full max-w-[1200px] items-center justify-center overflow-x-hidden'>
          <div className='left-0 z-40 h-full w-[150px] -translate-x-5 bg-opacity-20 bg-gradient-to-r from-[#D8C6C1] via-[#D8C6C1]/90 to-[#D8C6C1]/0' />
          <motion.div
          ...
          <div className='right-0 z-40 h-full w-[150px] -translate-x-5 bg-opacity-20 bg-gradient-to-l from-[#D8C6C1] via-[#D8C6C1]/90 to-[#D8C6C1]/0' />
        </div>
      </div>
    </section>
  )
